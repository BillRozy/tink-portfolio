...
export const TradesStreamRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<TradesStreamRequest>, I>>(
    object: I
  ): TradesStreamRequest {
    const message = createBaseTradesStreamRequest();
...
export const TradesStreamResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<TradesStreamResponse>, I>>(
    object: I
  ): TradesStreamResponse {
    const message = createBaseTradesStreamResponse();
    message.orderTrades =
...
export const OrderTrades = {
  ...
  fromPartial<I extends Exact<DeepPartial<OrderTrades>, I>>(
    object: I
  ): OrderTrades {
    const message = createBaseOrderTrades();
...
export const OrderTrade = {
  ...
  fromPartial<I extends Exact<DeepPartial<OrderTrade>, I>>(
    object: I
  ): OrderTrade {
    const message = createBaseOrderTrade();
...
export const PostOrderRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<PostOrderRequest>, I>>(
    object: I
  ): PostOrderRequest {
    const message = createBasePostOrderRequest();
    message.figi = object.figi ?? "";
...
export const PostOrderResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<PostOrderResponse>, I>>(
    object: I
  ): PostOrderResponse {
    const message = createBasePostOrderResponse();
    message.orderId = object.orderId ?? "";
...
export const CancelOrderRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<CancelOrderRequest>, I>>(
    object: I
  ): CancelOrderRequest {
    const message = createBaseCancelOrderRequest();
    message.accountId = object.accountId ?? "";
...
export const CancelOrderResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<CancelOrderResponse>, I>>(
    object: I
  ): CancelOrderResponse {
    const message = createBaseCancelOrderResponse();
...
export const GetOrderStateRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetOrderStateRequest>, I>>(
    object: I
  ): GetOrderStateRequest {
    const message = createBaseGetOrderStateRequest();
    message.accountId = object.accountId ?? "";
...
export const OrderState = {
  ...
  fromPartial<I extends Exact<DeepPartial<OrderState>, I>>(
    object: I
  ): OrderState {
    const message = createBaseOrderState();
    message.orderId = object.orderId ?? "";
...
export const OrderStage = {
  ...
  fromPartial<I extends Exact<DeepPartial<OrderStage>, I>>(
    object: I
  ): OrderStage {
    const message = createBaseOrderStage();
    message.price =
...
export class OrdersStreamServiceClientImpl implements OrdersStreamService {
  private readonly rpc: Rpc;
  constructor(rpc: Rpc) {
    this.rpc = rpc;
    this.TradesStream = this.TradesStream.bind(this);
  }
  TradesStream(request: TradesStreamRequest): Observable<TradesStreamResponse> {
    const data = TradesStreamRequest.encode(request).finish();
    ...
    return result.pipe(
      map((data) => TradesStreamResponse.decode(new _m0.Reader(data)))
    );
  }
}
