...
export const PostStopOrderRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<PostStopOrderRequest>, I>>(
    object: I
  ): PostStopOrderRequest {
    const message = createBasePostStopOrderRequest();
...
export const PostStopOrderResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<PostStopOrderResponse>, I>>(
    object: I
  ): PostStopOrderResponse {
    const message = createBasePostStopOrderResponse();
...
export const GetStopOrdersRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetStopOrdersRequest>, I>>(
    object: I
  ): GetStopOrdersRequest {
    const message = createBaseGetStopOrdersRequest();
    message.accountId = object.accountId ?? "";
...
export const GetStopOrdersResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetStopOrdersResponse>, I>>(
    object: I
  ): GetStopOrdersResponse {
    const message = createBaseGetStopOrdersResponse();
    message.stopOrders =
...
export const CancelStopOrderRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<CancelStopOrderRequest>, I>>(
    object: I
  ): CancelStopOrderRequest {
    const message = createBaseCancelStopOrderRequest();
    message.accountId = object.accountId ?? "";
...
export const CancelStopOrderResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<CancelStopOrderResponse>, I>>(
    object: I
  ): CancelStopOrderResponse {
    const message = createBaseCancelStopOrderResponse();
...
export const StopOrder = {
  ...
  fromPartial<I extends Exact<DeepPartial<StopOrder>, I>>(
    object: I
  ): StopOrder {
    const message = createBaseStopOrder();
    message.stopOrderId = object.stopOrderId ?? "";
...
export class StopOrdersServiceClientImpl implements StopOrdersService {
  private readonly rpc: Rpc;
  constructor(rpc: Rpc) {
    this.rpc = rpc;
    this.PostStopOrder = this.PostStopOrder.bind(this);
    this.GetStopOrders = this.GetStopOrders.bind(this);
    this.CancelStopOrder = this.CancelStopOrder.bind(this);
  }
  PostStopOrder(request: PostStopOrderRequest): Promise<PostStopOrderResponse> {
    const data = PostStopOrderRequest.encode(request).finish();
    ...
    return promise.then((data) =>
      PostStopOrderResponse.decode(new _m0.Reader(data))
    );
  }

  GetStopOrders(request: GetStopOrdersRequest): Promise<GetStopOrdersResponse> {
    const data = GetStopOrdersRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.StopOrdersService",
      "GetStopOrders",
      data
    ...
    return promise.then((data) =>
      GetStopOrdersResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  CancelStopOrder(
    ...
    const data = CancelStopOrderRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.StopOrdersService",
      "CancelStopOrder",
      data
    ...
    return promise.then((data) =>
      CancelStopOrderResponse.decode(new _m0.Reader(data))
    );
  }
}
