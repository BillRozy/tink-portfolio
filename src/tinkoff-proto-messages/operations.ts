...
export const OperationsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<OperationsRequest>, I>>(
    object: I
  ): OperationsRequest {
    const message = createBaseOperationsRequest();
...
export const OperationsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<OperationsResponse>, I>>(
    object: I
  ): OperationsResponse {
    const message = createBaseOperationsResponse();
    message.operations =
...
export const OperationTrade = {
  ...
  fromPartial<I extends Exact<DeepPartial<OperationTrade>, I>>(
    object: I
  ): OperationTrade {
    const message = createBaseOperationTrade();
...
export const PortfolioRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<PortfolioRequest>, I>>(
    object: I
  ): PortfolioRequest {
    const message = createBasePortfolioRequest();
    message.accountId = object.accountId ?? "";
...
export const PortfolioResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<PortfolioResponse>, I>>(
    object: I
  ): PortfolioResponse {
    const message = createBasePortfolioResponse();
    message.totalAmountShares =
...
export const WithdrawLimitsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<WithdrawLimitsRequest>, I>>(
    object: I
  ): WithdrawLimitsRequest {
    const message = createBaseWithdrawLimitsRequest();
    message.accountId = object.accountId ?? "";
...
export const WithdrawLimitsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<WithdrawLimitsResponse>, I>>(
    object: I
  ): WithdrawLimitsResponse {
    const message = createBaseWithdrawLimitsResponse();
    message.money = object.money?.map((e) => MoneyValue.fromPartial(e)) || [];
...
export const PortfolioPosition = {
  ...
  fromPartial<I extends Exact<DeepPartial<PortfolioPosition>, I>>(
    object: I
  ): PortfolioPosition {
    const message = createBasePortfolioPosition();
    message.figi = object.figi ?? "";
...
export const PositionsSecurities = {
  ...
  fromPartial<I extends Exact<DeepPartial<PositionsSecurities>, I>>(
    object: I
  ): PositionsSecurities {
    const message = createBasePositionsSecurities();
    message.figi = object.figi ?? "";
...
export const PositionsFutures = {
  ...
  fromPartial<I extends Exact<DeepPartial<PositionsFutures>, I>>(
    object: I
  ): PositionsFutures {
    const message = createBasePositionsFutures();
    message.figi = object.figi ?? "";
...
export const BrokerReportRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<BrokerReportRequest>, I>>(
    object: I
  ): BrokerReportRequest {
    const message = createBaseBrokerReportRequest();
    message.generateBrokerReportRequest =
...
export const BrokerReportResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<BrokerReportResponse>, I>>(
    object: I
  ): BrokerReportResponse {
    const message = createBaseBrokerReportResponse();
    message.generateBrokerReportResponse =
...
export const GenerateBrokerReportRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenerateBrokerReportRequest>, I>>(
    object: I
  ): GenerateBrokerReportRequest {
    const message = createBaseGenerateBrokerReportRequest();
    message.accountId = object.accountId ?? "";
...
export const GenerateBrokerReportResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenerateBrokerReportResponse>, I>>(
    object: I
  ): GenerateBrokerReportResponse {
    const message = createBaseGenerateBrokerReportResponse();
...
export const GetBrokerReportRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetBrokerReportRequest>, I>>(
    object: I
  ): GetBrokerReportRequest {
    const message = createBaseGetBrokerReportRequest();
    message.taskId = object.taskId ?? "";
...
export const GetBrokerReportResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetBrokerReportResponse>, I>>(
    object: I
  ): GetBrokerReportResponse {
    const message = createBaseGetBrokerReportResponse();
...
export const BrokerReport = {
  ...
  fromPartial<I extends Exact<DeepPartial<BrokerReport>, I>>(
    object: I
  ): BrokerReport {
    const message = createBaseBrokerReport();
    message.tradeId = object.tradeId ?? "";
...
export const GetDividendsForeignIssuerRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetDividendsForeignIssuerRequest>, I>
  >(object: I): GetDividendsForeignIssuerRequest {
    const message = createBaseGetDividendsForeignIssuerRequest();
    message.generateDivForeignIssuerReport =
...
export const GetDividendsForeignIssuerResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetDividendsForeignIssuerResponse>, I>
  >(object: I): GetDividendsForeignIssuerResponse {
    const message = createBaseGetDividendsForeignIssuerResponse();
    message.generateDivForeignIssuerReportResponse =
...
export const GenerateDividendsForeignIssuerReportRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GenerateDividendsForeignIssuerReportRequest>, I>
  >(object: I): GenerateDividendsForeignIssuerReportRequest {
    const message = createBaseGenerateDividendsForeignIssuerReportRequest();
    message.accountId = object.accountId ?? "";
    message.from = object.from ?? undefined;
    message.to = object.to ?? undefined;
...
export const GetDividendsForeignIssuerReportRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetDividendsForeignIssuerReportRequest>, I>
  >(object: I): GetDividendsForeignIssuerReportRequest {
    const message = createBaseGetDividendsForeignIssuerReportRequest();
    message.taskId = object.taskId ?? "";
    message.page = object.page ?? 0;
    return message;
...
export const GenerateDividendsForeignIssuerReportResponse = {
  ...
  fromPartial<
    I extends Exact<
      DeepPartial<GenerateDividendsForeignIssuerReportResponse>,
      I
    >
  >(object: I): GenerateDividendsForeignIssuerReportResponse {
    const message = createBaseGenerateDividendsForeignIssuerReportResponse();
    message.taskId = object.taskId ?? "";
    return message;
  },
...
export const GetDividendsForeignIssuerReportResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<GetDividendsForeignIssuerReportResponse>, I>
  >(object: I): GetDividendsForeignIssuerReportResponse {
    const message = createBaseGetDividendsForeignIssuerReportResponse();
...
export const DividendsForeignIssuerReport = {
  ...
  fromPartial<I extends Exact<DeepPartial<DividendsForeignIssuerReport>, I>>(
    object: I
  ): DividendsForeignIssuerReport {
    const message = createBaseDividendsForeignIssuerReport();
...
export class OperationsServiceClientImpl implements OperationsService {
  ...
  constructor(rpc: Rpc) {
    ...
    this.GetWithdrawLimits = this.GetWithdrawLimits.bind(this);
    this.GetBrokerReport = this.GetBrokerReport.bind(this);
    this.GetDividendsForeignIssuer = this.GetDividendsForeignIssuer.bind(this);
  }
  GetOperations(request: OperationsRequest): Promise<OperationsResponse> {
  ...
  GetWithdrawLimits(
    ...
    const data = WithdrawLimitsRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.OperationsService",
      "GetWithdrawLimits",
      data
    ...
    return promise.then((data) =>
      WithdrawLimitsResponse.decode(new _m0.Reader(data))
    );
  }

  GetBrokerReport(request: BrokerReportRequest): Promise<BrokerReportResponse> {
    const data = BrokerReportRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.OperationsService",
      "GetBrokerReport",
      data
    ...
    return promise.then((data) =>
      BrokerReportResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  GetDividendsForeignIssuer(
    ...
    const data = GetDividendsForeignIssuerRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.OperationsService",
      "GetDividendsForeignIssuer",
      data
    ...
    return promise.then((data) =>
      GetDividendsForeignIssuerResponse.decode(new _m0.Reader(data))
    );
  }
}
