...
export const GetAccountsRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetAccountsRequest>, I>>(
    _: I
  ): GetAccountsRequest {
    const message = createBaseGetAccountsRequest();
    return message;
...
export const GetAccountsResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetAccountsResponse>, I>>(
    object: I
  ): GetAccountsResponse {
    const message = createBaseGetAccountsResponse();
    message.accounts =
...
export const GetMarginAttributesRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetMarginAttributesRequest>, I>>(
    object: I
  ): GetMarginAttributesRequest {
    const message = createBaseGetMarginAttributesRequest();
...
export const GetMarginAttributesResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetMarginAttributesResponse>, I>>(
    object: I
  ): GetMarginAttributesResponse {
    const message = createBaseGetMarginAttributesResponse();
    message.liquidPortfolio =
...
export const GetUserTariffRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetUserTariffRequest>, I>>(
    _: I
  ): GetUserTariffRequest {
    const message = createBaseGetUserTariffRequest();
    return message;
...
export const GetUserTariffResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<GetUserTariffResponse>, I>>(
    object: I
  ): GetUserTariffResponse {
    const message = createBaseGetUserTariffResponse();
    message.unaryLimits =
...
export const UnaryLimit = {
  ...
  fromPartial<I extends Exact<DeepPartial<UnaryLimit>, I>>(
    object: I
  ): UnaryLimit {
    const message = createBaseUnaryLimit();
...
export const StreamLimit = {
  ...
  fromPartial<I extends Exact<DeepPartial<StreamLimit>, I>>(
    object: I
  ): StreamLimit {
    const message = createBaseStreamLimit();
...
export class UsersServiceClientImpl implements UsersService {
  ...
  constructor(rpc: Rpc) {
    ...
    this.GetMarginAttributes = this.GetMarginAttributes.bind(this);
    this.GetUserTariff = this.GetUserTariff.bind(this);
  ...
  GetMarginAttributes(
    ...
    const data = GetMarginAttributesRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.UsersService",
      "GetMarginAttributes",
      data
    ...
    return promise.then((data) =>
      GetMarginAttributesResponse.decode(new _m0.Reader(data))
    );
  }

  GetUserTariff(request: GetUserTariffRequest): Promise<GetUserTariffResponse> {
    const data = GetUserTariffRequest.encode(request).finish();
    const promise = this.rpc.request(
      "tinkoff.public.invest.api.contract.v1.UsersService",
      "GetUserTariff",
      data
    ...
    return promise.then((data) =>
      GetUserTariffResponse.decode(new _m0.Reader(data))
    );
  }
